**\*\*\*Prompt adjusted to address scope creep issue and bypass issue -**

When the same requests were submitted with the updated System instructions:

&#x09;The request for a device upgrade was ignored and only the plan changes were addressed

&#x09;In the case of the manager saying it was okay to future date the changes rather than backdate them a note was posted at the beginning of the output letting the user know that special requests need to go through the agent directly.
